...
""" + HTML_FOOTER
HTML_BULK_RESULTS_PAGE = """...""" # These templates remain the same
HTML_ANALYSIS_RESULT = """..."""   # These templates remain the same
...
# ... (All your other routes like /run_test, /webhook, etc. remain the same) ...
